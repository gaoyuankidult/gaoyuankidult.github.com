  ...
  <aside class="about-side">
    ...
    <div class="about-facts">
      ...
      <section class="about-fact">
        ...
        <p>研究具身异构机器人集体中自主性的形成机制，探讨决策架构如何在形态多样性、信息不对称与长时间尺度的目标结构之间取得平衡。重点关注大型基础模型作为多机器人推理基底的潜力——在行动空间本质上不可通约的机器人之间实现任务分解、角色分配与应急处理的协商——同时保持只有通过与物理世界的感知-运动耦合才能提供的根基性。</p>
      </section>
    </div>
  </aside>
</div>