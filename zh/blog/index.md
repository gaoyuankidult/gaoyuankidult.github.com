...
<p class="page-intro fade-in">思考、片段和游离的想法——写在研究与艺术之间的空间里。</p>
...
{% assign posts_by_year = site.posts | where: "lang", "zh" | group_by_exp: "post", "post.date | date: '%Y'" %}
...
<div class="blog-year" data-year="{{ year_group.name }}">
  <div class="blog-year-header" onclick="toggleBlogYear(this)">
    ...
    <span class="blog-year-count">{{ year_group.items.size }} 篇</span>
    <span class="blog-year-toggle">展开</span>
  </div>
