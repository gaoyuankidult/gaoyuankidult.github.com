...
<div class='container'>
	...
	<h6></h6>
	<button id="abstract_btn" class="button black" onclick="toggleAbstract(this);" type="button">Abstract</button><button class="button black" onclick="location.href='papers/investigate-deep-learning-proximics.pdf'" type="button">Download</button>
...
<div class='container'>
    ...
    <h6></h6>
	<button id="abstract_btn" class="button black" onclick="toggleAbstract(this);" type="button">Abstract</button><button class="button black" onclick="location.href='papers/when-robot-does-not-help.pdf'" type="button">Download</button>
